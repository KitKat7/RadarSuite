...
#define PIN_SCK		A6
#define PIN_DAT		A7
#define PIN_CS		A8  //数字电位器片选

//****************************************************************

#define FSYNC_0()		digitalWrite(PIN_FSYNC, LOW)
#define FSYNC_1()		digitalWrite(PIN_FSYNC, HIGH)

#define SCK_0()		digitalWrite(PIN_SCK, LOW)
#define SCK_1()		digitalWrite(PIN_SCK, HIGH)

#define DAT_0()		digitalWrite(PIN_DAT, LOW)
#define DAT_1()		digitalWrite(PIN_DAT, HIGH)	

#define CS_0()		digitalWrite(PIN_CS, LOW)	
#define CS_1()		digitalWrite(PIN_CS, HIGH)	
