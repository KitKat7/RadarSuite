...
//  Serial.printf("\ninput0\n");
  for (i = 0; i < 500; i++)
  {
    Serial.printf("%d\t", testInput1[i]);
  }
  Serial.printf("\ninput1\n");

  for (i = 0; i < 500; i++)
  {
    Serial.printf("%d\t", testInput2[i]);
  }
  Serial.printf("\ninput2\n");
  ...
  // Serial3.printf("Max %f, %f Hz\n", testOutput[i], i*10000/512.0);

  //  for(int j=0; j<255; j++)
  //  {
  //    Serial.printf("%f\t", testOutput[j]);
  //  }
  //  Serial.printf("\nfft above\n");
  ...
  //  for (int j = 0; j < 512; j++)
  //  {
  //    if (testInput[j] >=  testInput[i] && testInput[j] > - 10)
  //    {
  //      i = j;
  //    }
  //  }
