...
void setup() {
  ...
  // ww[2044] = arm_cos_f32(511 * 511 * -PI*(200-0)/512/10000);
  // ww[2045] = arm_sin_f32(511 * 511 * -PI*(200-0)/512/10000);
  // ww[0] = ww[2044];
  // ww[1] = ww[2045];
  ww[2046] = 0;
  ww[2047] = 0;
  // aa[2046] = ww[2044] * aa[2046] - ww[2045] * aa[2047];
  // aa[2047] = ww[2044] * aa[2047] + ww[2045] * aa[2046];
...
//  }
  ...
  // w0 = arm_cos_f32(2*PI*(200-0)/512/10000);
  // w1 = arm_sin_f32(2*PI*(200-0)/512/10000);
